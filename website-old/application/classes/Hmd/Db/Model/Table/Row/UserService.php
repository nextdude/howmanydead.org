...
/**
 * @see Hmd_Db_Model_Table_Row_Abstract
 */
require_once 'Hmd/Db/Model/Table/Row/Abstract.php';

/**
 * Hmd_Db_Model_Table_Row_UserService - An hmd db model table row class.
 *
 * @category   Hmd
 * @package    Hmd_Db_Model_Table
 * @subpackage Hmd_Db_Model_Table_Row
 */
class Hmd_Db_Model_Table_Row_UserService extends Hmd_Db_Model_Table_Row_Abstract {
